  ...
  openDynamicForm() {
    const formConfig: TabConfig[] = [{
      ...
      fields: [
        ...
        { name: 'cnpj', placeholder: 'CNPJ', type: 'text', required: true, mask: '00.000.000/0000-00' },
  ...
  openEditDialog(company: any) {
    const formConfig: TabConfig[] = [{
      ...
      fields: [
        ...
        { name: 'cnpj', placeholder: 'CNPJ', type: 'text', required: true, mask: '00.000.000/0000-00', defaultValue: company.cnpj },
        ...
        { name: 'telephone', placeholder: 'Telefone', type: 'text', required: true, mask: '(00) 0000-0000||(00) 00000-0000', defaultValue: company.telephone },
